...
```bash
# Get page metadata
curl -s -X GET "https://api.notion.com/v1/pages/<your-page-id>" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" | jq '{title: .properties.title.title[0].plain_text, url, last_edited_time}'

# Get page content blocks
curl -s -X GET "https://api.notion.com/v1/blocks/<your-page-id>/children?page_size=100" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" | jq '.results[] | {type, text: (.[.type].rich_text // [] | map(.plain_text) | join("")), has_children}'
```
...
```bash
curl -s -X GET "https://api.notion.com/v1/blocks/<your-block-id>/children" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" | jq '.results[] | {type, text: (.[.type].rich_text // [] | map(.plain_text) | join(""))}'
```
...
```bash
curl -s -X POST "https://api.notion.com/v1/search" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" --header "Content-Type: application/json" -d @/tmp/notion_request.json | jq '.results[] | {id, object, title: .properties.title.title[0].plain_text // .title[0].plain_text}'
```
...
```bash
curl -s -X POST "https://api.notion.com/v1/databases/<your-database-id>/query" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" --header "Content-Type: application/json" -d @/tmp/notion_request.json | jq '.results[] | {id, properties}'
```
...
```bash
curl -s -X POST "https://api.notion.com/v1/databases/<your-database-id>/query" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header 'Notion-Version: 2022-06-28' --header 'Content-Type: application/json' -d @- << 'EOF'
{
  "filter": {
  "property": "Status",
  "select": {"equals": "Done"}
...
```bash
curl -s "https://api.notion.com/v1/databases/<your-database-id>" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" | jq '{title: .title[0].plain_text, properties: .properties | keys}'
```
...
```bash
curl -s "https://api.notion.com/v1/pages/<your-page-id>" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" | jq '{id, url, properties}'
```
...
```bash
curl -s -X POST 'https://api.notion.com/v1/pages' --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header 'Notion-Version: 2022-06-28' --header 'Content-Type: application/json' -d @- << 'EOF'
{
...
```bash
curl -s -X PATCH "https://api.notion.com/v1/pages/<your-page-id>" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header 'Notion-Version: 2022-06-28' --header 'Content-Type: application/json' -d @- << 'EOF'
{
  "properties": {
...
```bash
curl -s -X PATCH "https://api.notion.com/v1/pages/<your-page-id>" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" --header "Content-Type: application/json" -d @/tmp/notion_request.json
```
...
```bash
curl -s "https://api.notion.com/v1/blocks/<your-block-id>/children?page_size=100" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" | jq '.results[] | {type, id}'
```
...
```bash
curl -s -X PATCH "https://api.notion.com/v1/blocks/<your-page-id>/children" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header 'Notion-Version: 2022-06-28' --header 'Content-Type: application/json' -d @- << 'EOF'
{
  "children": [
  {
  "object": "block",
...
```bash
curl -s -X DELETE "https://api.notion.com/v1/blocks/<your-block-id>" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header 'Notion-Version: 2022-06-28'
```

### List Users

```bash
curl -s "https://api.notion.com/v1/users" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" | jq '.results[] | {id, name, type}'
```
...
```bash
curl -s 'https://api.notion.com/v1/users/me' --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header 'Notion-Version: 2022-06-28'
```

### Create Database

```bash
curl -s -X POST 'https://api.notion.com/v1/databases' --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header 'Notion-Version: 2022-06-28' --header 'Content-Type: application/json' -d @- << 'EOF'
{
  "parent": {"page_id": "parent-page-id"},
...
```bash
# First request
curl -s -X POST "https://api.notion.com/v1/databases/<your-database-id>/query" --header "Authorization: Bearer $(printenv NOTION_TOKEN)" --header "Notion-Version: 2022-06-28" --header "Content-Type: application/json" -d @/tmp/notion_request.json
