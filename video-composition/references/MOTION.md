...
- Before browser work, run `node scripts/review-project.mjs --project . --phase preflight` once. It rejects contract, sidecar, local-font, path, and HyperFrames lint failures.
