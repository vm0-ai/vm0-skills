...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/me" -H "Authorization: Bearer $FIGMA_TOKEN"'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '{name, lastModified, version, document: .document.children[0].name}'
```

Get specific version:

```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>?version=123" -H "Authorization: Bearer $FIGMA_TOKEN"'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>/nodes?ids=<node-ids>" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.nodes'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/images/<your-file-key>?ids=<node-ids>&format=png&scale=2" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.images'
```
...
```bash
IMAGE_URL="$(bash -c 'curl -s -X GET "https://api.figma.com/v1/images/<your-file-key>?ids=<node-id>&format=png" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq -r '.images["<node-id>"]')"
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>/images" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.meta.images'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>/comments" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.comments[] | {id, message: .message, user: .user.handle, created_at}'
```
...
```bash
bash -c 'curl -s -X POST "https://api.figma.com/v1/files/<your-file-key>/comments" -H "Authorization: Bearer $FIGMA_TOKEN" -H "Content-Type: application/json" -d @/tmp/figma_request.json'
```
...
```bash
curl -s -X DELETE "https://api.figma.com/v1/files/<your-file-key>/comments/<comment-id>" -H "Authorization: Bearer $FIGMA_TOKEN"
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>/versions" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.versions[] | {id, created_at, label, description, user: .user.handle}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/teams/<your-team-id>/projects" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.projects[] | {id, name}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/projects/<your-project-id>/files" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.files[] | {key, name, last_modified}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/teams/<your-team-id>/components" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.meta.components[] | {key, name, description, containing_frame: .containing_frame.name}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/components/<your-component-key>" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '{key, name, description, containing_frame}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/teams/<your-team-id>/styles" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.meta.styles[] | {key, name, description, style_type}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/styles/<your-style-key>" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '{key, name, description, style_type}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/me" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '{id, email, handle, img_url}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/teams/<your-team-id>/members" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.members[] | {id, email: .user.email, handle: .user.handle, role}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>/component_sets" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.meta.component_sets[] | {key, name, description}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/teams/<your-team-id>/files?name=<search-query>" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.files[] | {key, name, last_modified}'
```
...
```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq -r '.document.children[0].children[] | select(.type=="FRAME") | .id' | paste -sd "," -
```

Then export frames (replace `<frame-ids>` with the comma-separated frame IDs from the previous response):

```bash
bash -c 'curl -s -X GET "https://api.figma.com/v1/images/<your-file-key>?ids=<frame-ids>&format=png&scale=2" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.images'
```
...
```bash
# Get color styles
bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq '.styles | to_entries[] | select(.value.styleType == "FILL") | {name: .value.name, key: .value.key}'
```
...
```bash
# Get current version
CURRENT_VERSION=$(bash -c 'curl -s -X GET "https://api.figma.com/v1/files/<your-file-key>" -H "Authorization: Bearer $FIGMA_TOKEN"' | jq -r '.version')
...
- Token Settings: https://www.figma.com/settings
