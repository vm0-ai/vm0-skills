...
GROUPS = [
    ("Orientation and closure", ["orientation/authority-cover","orientation/briefing-map","orientation/section-pivot","orientation/public-action-close"]),
...
PALETTES = {
    "authority-broadcast": {"canvas": "#0B111C", "header": "#16243B", "text": "#F3F6FA", "label": "#182943", "label_text": "#D9E3EF"},
...
parser.add_argument("--color-system", choices=PALETTES, default="authority-broadcast")
...
if args.color_system == "authority-broadcast":
