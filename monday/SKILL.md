...
```bash
curl -s -X POST "https://api.monday.com/v2" --header "Authorization: $(printenv MONDAY_TOKEN)" --header "API-Version: 2024-10" --header "Content-Type: application/json" -d @/tmp/monday_request.json
```
